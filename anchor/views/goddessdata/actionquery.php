...
$query = $query == '' ? "SELECT * FROM $db_name._sys_goddess" : "SELECT * FROM $db_name._sys_goddess WHERE GoddessDBID = '$query'";
	...
	if(mysqli_num_rows($result)) {
		...
		echo '<tr align="left">'
                . '<th>GoddessDBID</th><th>GoddessName</th><th>RoleDBID</th><th style="min-width:500px">AboutMe</th><th style="min-width:180px">Birthday</th><th>CityTmpID</th><th>CountryTmpID</th><th>MainImageDBID</th>'
