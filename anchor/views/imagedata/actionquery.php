...
mysqli_select_db($con, $db_name);
 mysqli_query($con, "set character set 'utf8'");//utf-8 讀中文
	...
	if(mysqli_num_rows($result)) {
		...
		echo '<tr align="left"><th>ImageDBID</th><th>ImagePublicID</th><th>ImageDescription</th><th>ImageRatio</th><th>GoddessDBID</th><th>CreateTime</th>'
                        . '<th>WinCount</th><th>LostCount</th><th>TotalWinCount</th><th>TotalLostCount</th><th>Durability</th><th>CommentCount</th>';
